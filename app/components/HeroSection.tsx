            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <Link
                    href="/projects"
                    className="inline-flex items-center px-6 py-3 bg-accent dark:bg-dark-accent dark:hover:bg-dark-hover-accent text-white rounded-lg font-medium hover:bg-hover-accent transition"
                  >
                ...
                >
                  <Link
                    href="/contact"
                    className="inline-flex items-center px-6 py-3 bg-secondary text-gray-800 dark:bg-dark-secondary dark:text-gray-200 rounded-lg font-medium hover:bg-secondary dark:hover:bg-dark-background transition"
                  >
                    Get In Touch
                  </Link>
                </motion.div>
